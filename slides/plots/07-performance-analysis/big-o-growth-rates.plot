set terminal tikz latex fontscale 1 butt charsize 8pt,10pt size 15,7.5 #createstyle # background rgb "black"
set output "plots/07-performance-analysis/big-o-growth-rates.tex"    # Name the output file
...
set ylabel "Operations / Time~~$f(n)$" #font ",20"
set xrange [0:xmax]
set yrange [0:ymax]
set border lw 2
...
set label "$\\log_2 n$"               at nx_log,   f_log(nx_log)    left offset 0.5,-0.25 tc rgb "#488f31" #font ",20"
set label "$n$"                    at nx_n,     f_n(nx_n)        left offset 0.5,0.25 tc rgb "#88a037" #font ",20"
set label "$n\\log_2n$"  at nx_nlogn, f_nlogn(nx_nlogn) left offset 0.5,0 tc rgb "#c0af4a" #font ",20"
set label "$n^2$"        at nx_n2,    f_n2(nx_n2)      center offset 0.5,1 tc rgb "#f4bd6a" #font ",20"
set label "$n^3$"        at nx_n3,    f_n3(nx_n3)      center offset 0,1 tc rgb "#ef9556" #font ",20"
set label "$2^n$"        at nx_2n,    f_2n(nx_2n)      center offset 0,1 tc rgb "#e56b4e" #font ",20"
set label "$n!$"        at nx_fact,  ymax  center offset 0,1 tc rgb "#de425b" #font ",20"
