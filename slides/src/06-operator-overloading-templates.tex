...
\item
  Apply the Rule of Three to properly handle pointer member variables.
\end{itemize}
\end{frame}
...
\item
  ...
  the function must be a member of the class.
\item
...
\begin{frame}[fragile]{Binary Operator Overloads as Nonmember Functions}
...
\protect\hypertarget{classes-and-pointer-member-variables-revisited}{}
\begin{itemize}
\item
...
\protect\hypertarget{operator-overloading-member-versus-nonmember-1-of-2}{}
\begin{itemize}
\item
...
\protect\hypertarget{overloading-the-array-index-subscript-operator}{}
\begin{itemize}
\item
