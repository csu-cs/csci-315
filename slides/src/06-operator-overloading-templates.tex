...
\protect\hypertarget{objectives-1-of-2}{}
...
\item
  Learn about \lstinline{friend} functions.
\item
...
\protect\hypertarget{objectives-2-of-2}{}
\begin{itemize}
\item
...
\texttt{g++} may default to an older C++ standard. If so, add \lstinline[language=Bash, identifierstyle=\color{white}]{-std=c++20} to your compiler arguments to user template abbreviation.
