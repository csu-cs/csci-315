...
\begin{frame}{Approaches to Analyzing Performance}
  ...
  \begin{enumerate}
  \item<2->
    \textbf{Empirical}: Measure performance for examples.\\ But, what does this tell us in general?
  \item<3->
    \textbf{Analytical}:
    \begin{itemize}
...
% \centerline{\includegraphics[width=0.8\textwidth]{performance-growth-rate1}}
%\end{block}
