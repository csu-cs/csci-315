...
\begin{itemize}[<+->]
  \item Diagnose problems by identifying \emph{errors}\\ and \emph{performance bottlenecks}.
  \item Explain performance issues with \emph{asymptotic and empirical analysis}.
  \item  Use the \emph{Unix/Linux environment} confidently for programming, testing, and debugging.
  \item Develop the skills of \emph{a competent junior programmer} ready for entry-level software work.
  \begin{itemize}
  \item
...
\begingroup
  ...
  \rowcolor{CSUgold}\textcolor{black}{\textbf{CSCI 315}}      &\textcolor{black}{Create both simple and somewhat complex programs
...
\centerline{--\href{https://en.wikipedia.org/wiki/Henry_Petroski}{Henry Petroski}}
\centerline{%
  \includegraphics[width=0.67\textwidth]{sci-and-eng}%
}
\pause{}
\begin{itemize}
  \item Science and Engineering are both in Computer \emph{\textsf{Science}}.
...
\section[\href{https://csu-cs.github.io/csci-315/syllabus}{Syllabus}]{Syllabus}
...
\begin{block}{Setting up WSL with Ubuntu/Debian on Windows 10/11}
  \begin{itemize}
  \item Follow the \href{https://docs.microsoft.com/en-us/windows/wsl/install}{Official Installation Guide} to install Ubuntu 26.04 or later.
...
\begin{frame}{Joining the Class}
  ...
  \item Click on the \href{https://github.com/csu-cs/CSCI-315-2026-Fall/}{\texttt{CSCI-315-2026-Fall}} repository.
  \item Click ``Fork''.
