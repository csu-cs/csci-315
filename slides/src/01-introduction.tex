...
\onslide<4->{\begin{forest}
  [A, for tree={minimum size=1.5em, inner sep=0, font=\small}
    [B
      [D,
        [H
        ]
...
\begin{frame}{Decisions, decisions\textellipsis\\When to choose one over other?}
\begin{columns}[c]
\column{0.4\textwidth}
  \centering
...
\node[draw,
    minimum width=4cm,
    minimum height=0.5cm] (block1) {CSCI 235 Procedural Programming};

\node[draw,
    below=7mm of block1,
    minimum width=4cm,
    minimum height=0.5cm] (OOP) {CSCI 325 Object Oriented Programming};

\node[draw,
    left=of OOP,
    minimum width=2.5cm,
    minimum height=0.5cm] (block3) {CSCI 301 Survey of Scripting Languages};

\node[draw,
    right=of OOP,
    minimum width=2.5cm,
    minimum height=0.5cm,
    align=center] (block4) {CSCI 332 Applied Networking};

\node[draw,
    right=of block4,
    minimum width=2.5cm,
    minimum height=0.5cm,
    align=center] (332Elet) {Electives:\\CSCI 334 UI Programming\\CSCI 360 Mobiles App Dev.\\CSCI 432 Mobile Networks\\CSCI 433 Network Security\\CSCI 425 Network Penetration};
...
\node[draw,
    ...
    minimum height=0.5cm,
    fill=CSUgold,
    text=black] (DS) {\bfseries CSCI 315 Data Structure Analysis };

\node[draw,
    left=of DS,
    minimum width=2.5cm,
    minimum height=0.5cm] (Arch) {CSCI 330 Computer Architecture };

\node[draw,
    right=of DS,
    minimum width=2.5cm,
    minimum height=0.5cm] (block7) {CSCI 495 Systems Analysis \& Software Design};

\node[draw,
    below=12mm of DS,
    minimum width=4cm,
    minimum height=0.5cm] (Alg) {CSCI 415 Algorithms };

\node[draw,
    below=12mm of Arch,
    minimum width=2.5cm,
    minimum height=0.5cm] (OS) {CSCI 431 Operating Systems };

\node[draw,
    right=of Alg,
    minimum width=2.5cm,
    minimum height=0.5cm,
    align=center] (proj1) {CSCI 496 Senior Portfolio Review\\CSCI 497 Senior Project Design };

\node[draw,
    right=of proj1,
    minimum width=2.5cm,
    minimum height=0.5cm,
    align=center] (dsElect) {Electives: \\ CSCI 409 A.I.\\CSCI 450 Graphics };

\node[draw,
    below=7mm of proj1,
    minimum width=2.5cm,
    minimum height=0.5cm,
    align=center] (proj2) {CSCI 498 Senior Project Construction };

\node[draw,
    below=7mm of proj2,
    minimum width=2.5cm,
    minimum height=0.5cm,
    align=center] (proj3) {CSCI 498 Senior Project Defense };

\draw[-latex] (block1) edge (OOP)
    (block1) edge (block3)
    (block1) edge (block4)
    (OOP) edge (DS)
    (OOP) edge (Arch)
...
\begin{frame}{Joining the Class}
  ...
  \item Click on the \href{https://github.com/csu-cs/CSCI-315-2025-Fall/}{\texttt{CSCI-315-2025-Fall}} repository.
  \item Click ``Fork''.
