...
\begin{frame}{3D Visualization}
  \center{}
  \begin{tikzpicture}[every mark/.append style={thick, scale=1.5, draw=white}]
    \begin{axis}[
      ...
      % Level 2
      \addplot3[yellow!50!black, opacity=0.75] coordinates {
          (15, 5, 2) (10, 5, 2)
  
          (15, 2.5, 2) (10, 2.5, 2)
        };

      \addplot3[codeKeyword!50!black, opacity=0.75] coordinates {
          (20, 5, 2) (15, 5, 2)
  
          (20, 2.5, 2) (15, 2.5, 2)
        };

      \addplot3[red!50!black, opacity=0.75] coordinates {
          (20, 2.5, 2) (15, 2.5, 2)
  
          (20, 0, 2) (15, 0, 2)
        };

        \addplot3[green!50!black, opacity=0.75] coordinates {
          (15, 2.5, 2) (10, 2.5, 2)
      ...
      % Level 1
      \addplot3[green, opacity=0.67] coordinates {
          (10, 5, 1) (0, 5, 1)
  
          (10, 0, 1) (0, 0, 1)
        };
      
      \addplot3[yellow, opacity=0.67] coordinates {
          (10, 10, 1) (0, 10, 1)
  
          (10, 5, 1) (0, 5, 1)
        };

      \addplot3[red, opacity=0.67] coordinates {
          (20, 5, 1) (10, 5, 1)
  
          (20, 0, 1) (10, 0, 1)
        };

      \addplot3[codeKeyword, opacity=0.67] coordinates {
          (20, 10, 1) (10, 10, 1)
      ...
      % % Root
      % \addplot3[draw=black, white, opacity=0.5] coordinates {
      %     (0, 0, 0) (20, 0, 0)

      %     (0, 10, 0) (20, 10, 0)
      %   };
  
      \addplot3[only marks, white, every mark/.append style={draw=CSUblue}] coordinates {
          % (0, 0, 1)
          (5.1, 8.3, 0) (12.2, 2.9, 0) (17.1, 6.1, 0) (19.0, 5.7, 0) (19.9, 1.1, 0)
        };

      \addplot3[only marks, yellow, every mark/.append style={draw=CSUblue}] coordinates {
          (.7, 6.0, 1) % yellow
          (7.2, 9.8, 1) % yellow
          (1.9, 5.9, 1) % yellow
        };

      \addplot3[only marks, red] coordinates {
          (11.9, 1.9, 1) % red
          (16.3, 1.4, 1) % red
          (10.7, 1.6, 1) % red
          (17.2, 4.8, 1) % red
      ...
      \addplot3[only marks, green, every mark/.append style={draw=CSUblue}] coordinates {
          (.9, 3.1, 1) % green
        };
      ...
      \addplot3[only marks, green!50!black] coordinates {
          (11.0, .1, 2) % dark green
        };


      % Root
      \addplot3[draw=black, white, opacity=0.67, draw=white] coordinates {
        (0, 0, 0) (20, 0, 0)
