...
\begin{frame}{Class Organization}
  ...
  \item \lstinline{friend}: grant member-level access to non-member functions or classes. Use sparingly (or not at all); this reduces encapsulation and increases coupling.
  \end{itemize}
\end{frame}
...
\lstinline{mSize} starts with 'm' to indicate member variable.
\end{frame}
