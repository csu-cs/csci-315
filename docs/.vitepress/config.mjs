...
export default {
	lang: 'en-US',
	title: 'CSCI 315',
	description: 'Data Structure Analysis',
	lastUpdated: true,
	cleanUrls: true,
	base: '/csci-315/',
	...
	head: [
		// Add Favicon
		[ 'link', { rel: 'icon', type: 'image/png', href: '/csci-315/favicon-32x32.png', sizes: '32x32'} ],
		[ 'link', { rel: 'icon', type: 'image/png', href: '/csci-315/favicon-16x16.png', sizes: '16x16'} ],
		[ 'link', { rel: 'apple-touch-icon', href: '/csci-315/apple-touch-icon.png', sizes: '180x180'} ],
		[ 'link', { rel: 'manifest', href: '/csci-315/site.webmanifest'} ],
	],
	...
	return [
		...
		},
		{
			...
			items: [
				...
				{ text: "Quick and Merge Sorting", link: "/lectures/11-quick-and-merge-sort" },
			]
		},
		{
			...
			collapsed: true,
			items: [
				{ text: "Stacks & Queues", link: "/lectures/12-stacks-queues" },
		...
		},
		{
			...
			collapsed: true,
			items: [
				{ text: "Project 3 Optimizations", link: "/lectures/25-project3" },
				{ text: "Review", link: "/lectures/26-review" },
			]
		},
	]
}